...
wandb.init(project="ANLP_Project", name="NLI-Pretrained_Roberta-FT-final")
...
def train_model(model, train_dataloader, val_dataloader,test_dataloader):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"/tmp/ketaki/nlipretrained_checkpoints_scheduler/checkpoint_{epoch}.pt")
